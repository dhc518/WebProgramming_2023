...
<%
	...
	while(rs.next()){
		...
		str += "&nbsp;</td><td>&nbsp;"; 
		str += "<input type=\"button\" value=\"설문하기\" onclick=\"goPoll("+ rs.getInt("qid") +")\">"; 
		str += "&nbsp;</td><td>&nbsp;"; str += "<input type=\"button\" value=\"결과보기\" onclick=\"viewResult("+ rs.getInt("qid") +")\">";
		str += "</td></tr>";
		count++;
	}
	out.print("설문 리스트");
